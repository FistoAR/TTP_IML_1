  ...
  return (
    <div className="p-[1vw] font-sans bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-[1vw]">
        ...
        <span className="text-[1.1vw] text-gray-600">
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-[0.3vw]">
                      ...
                      <span className="bg-white/20 px-[0.8vw] py-[0.2vw] rounded text-[0.85vw] font-medium ml-[0.15vw]">
                                  ...
                                  <table className="w-full border-collapse text-[0.85vw]">
                                    <thead>
                                      <tr className="bg-gray-50">
                                        <th className="px-[0.9vw] py-[0.9vw] text-left border-b border-gray-200 text-gray-700 font-semibold">
                                          S. No.
                                        </th>
                                        <th className="px-[0.9vw] py-[0.9vw] text-left border-b border-gray-200 text-gray-700 font-semibold">
                                          Date
                                        ...
                                        <th className="px-[0.9vw] py-[0.9vw] text-center border-b border-gray-200 text-gray-700 font-semibold">
                                          Actions
                                        </th>
                                      </tr>
                                    </thead>
