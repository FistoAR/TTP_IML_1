...
const PurchaseDetails = () => {
    ...
    if (entry) {
      ...
      if (isTrackingSheet) {
        ...
        setTrackingForm({
          ...
          lidColor: entry.lidColor || "",
          tubColor: entry.tubColor || "",
          quantity: "",
          comment: "",
        });
      } else {
  ...
  const addTrackingFollowup = () => {
    ...
    // Clear quantity and comment fields
    setTrackingForm((prev) => ({ ...prev, quantity: "", comment: "" }));
  };
  ...
  return (
    <div className="p-[1vw] font-sans bg-gray-50 min-h-screen">
      ...
      <div className="flex justify-between items-center mb-[1vw]">
        <h1 className="text-[2.2vw] text-gray-800 font-semibold">
            ...
            <div className="border-t border-gray-300 pt-[1vw] mb-[1vw]">
              ...
              <div className="grid grid-cols-4 gap-[1.5vw]">
                ...
                <div className="col-span-1">
                  <label className="block mb-[0.5vw] text-[0.85vw] font-medium text-gray-700 opacity-0 pointer-events-none select-none">submit button</label>
                  <button
