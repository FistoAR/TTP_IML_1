...
export default function NewOrder({ existingOrder, onSubmit, onCancel, onBack }) {
    ...
    <div className="bg-gray-50 p-0">
      <div className="max-w-[90vw] mx-auto bg-white rounded-[0.8vw] shadow-sm pb-[.75vw]">
        ...
        <div className="flex justify-between items-baseline p-[1vw_1.5vw] border-b border-gray-200">
          <button className="flex gap-[.5vw] items-center cursor-pointer" onClick={handleBack}>
            <svg
          ...
          <span className="text-[1vw]">Back</span></button>
      ...
      title={
        <div className="flex justify-between items-center w-full">
          <span>
            ...
            product.productName &&
            product.size
              ? `Order ${index + 1}: ${product.productName} - ${product.size}`
      ...
      {!product.isCollapsed && (
        <>
            ...
            <div className="grid grid-cols-4 gap-[1.5vw]">
              ...
              <Select
                ...
                onChange={(e) => {
                  ...
                  if (isDuplicateProduct(product.productName, newSize, product.imlType)) {
                    alert(`This product combination (${product.productName} - ${newSize} - ${product.imlType}) already exists!`);
                    return;
                  }
              ...
              <Select
                ...
                onChange={(e) => {
                  ...
                  // Check for duplicates
                  if (product.productName && product.size && isDuplicateProduct(product.productName, product.size, newImlType)) {
                    alert(`This product combination (${product.productName} - ${product.size} - ${newImlType}) already exists!`);
                    return;
                  }
                  setProducts(
                    products.map((p) =>
            ...
            {product.imlType === "LID & TUB" ? (
              ...
              <div className="grid grid-cols-4 gap-[1.5vw] mt-[1vw]">
                <Input
                  ...
                  onChange={(e) => {
                    const type = product.imlType === "LID" ? "lid" : "tub";
                    updateQuantity(
                      product.id,
                      type,
                      "LabelQty",
                ...
                />
                <Input
                  label={`Production Qty${product.imlType !== "LID" && product.imlType !== "TUB" ? "" : ` (${product.imlType})`}`}
                  required
                  placeholder="Enter Production Quantity"
                  value={product.imlType === "LID" ? product.lidProductionQty : product.tubProductionQty}
                  onChange={(e) => {
                    const type = product.imlType === "LID" ? "lid" : "tub";
                    updateQuantity(
                      product.id,
                ...
                />
                <Input
                  label={`Stock${product.imlType !== "LID" && product.imlType !== "TUB" ? "" : ` (${product.imlType})`}`}
                  required
                  placeholder="Stock"
                  value={product.imlType === "LID" ? product.lidStock : product.tubStock}
                  onChange={(e) => {}}
                  disabled
                />
                <Input
            ...
            {product.designType === "existing" ? (
              <div className="grid grid-cols-2 gap-[2vw]">
                <div>
                  ...
                  <div className="border-2 border-dashed border-gray-300 rounded-[0.6vw] p-[1vw] min-h-[11vw] bg-white mb-[1vw]">
                    <div className="grid grid-cols-3 gap-[1.5vw]">
                ...
                <div>
                  ...
                  <div className="border-2 relative border-gray-300 rounded-[0.6vw] p-[1vw] min-h-[11vw] bg-white flex items-center justify-center">
                      ...
                      (() => {
                        ...
                        return (
                          <div className="text-center w-full">
                            ...
                            <div className="flex justify-center align-center gap-[.5vw]">
                            ...
                            <div className="flex justify-end gap-[1vw] mt-[2vw]">
                              <button
                                ...
                                className="px-[1vw] py-[0.4vw] cursor-pointer bg-blue-600 text-white rounded-[0.4vw] hover:bg-blue-700 font-medium text-[0.85vw] transition-all duration-200 shadow-sm hover:shadow-md flex items-center gap-[0.4vw] justify-center absolute right-[.5vw] bottom-[.5vw]"
                              >
                                <svg
                                  className="w-[1vw] h-[1vw]"
                                  fill="none"
          ...
          <Section title="Payment Details - Client Payments">
            ...
            {/* Compact Product Selection & Payment Form */}
            <div className="grid grid-cols-2 gap-[1.5vw]">
              ...
              <div>
                    ...
                    <input
                      ...
                      checked={
                        ...
                        selectedProducts.length ===
                          products.filter((p) => !hasPaymentRecord(p.id)).length
                      }
                      onChange={(e) => handleSelectAll(e.target.checked)}
                      disabled={products.every((p) => hasPaymentRecord(p.id))}
                ...
                <div className="border-2 border-gray-200 rounded-[0.5vw] max-h-[22vw] overflow-y-auto">
                  {products.map((product) => {
                    const payment = getProductPayment(product.id);
                    const isPaid = !!payment;

                    return (
                      <div
                        key={product.id}
                        className={`p-[0.75vw] border-b border-gray-200 last:border-b-0 transition-colors ${
                          isPaid
                            ? "bg-green-50"
                        ...
                        <div className="flex items-center gap-[0.75vw]">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center justify-between gap-[0.5vw]">
                              ...
                              {isPaid && (
                                <span className="text-[0.65vw] bg-green-100 text-green-700 px-[0.5vw] py-[0.15vw] rounded font-medium flex-shrink-0">
                                  ✓ Received
                                </span>
                              )}
                            </div>
                            ...
                            <div className="flex items-center justify-between mt-[0.25vw]">
                              ...
                              {isPaid && payment.paymentType === "advance" && (
                                <span className="text-[0.7vw] text-green-600 font-semibold">
                                  Received: ₹{payment.amount}
                                </span>
                              )}
                              {isPaid && payment.paymentType === "po" && (
                                <span className="text-[0.7vw] bg-blue-100 text-blue-700 px-[0.5vw] py-[0.15vw] rounded font-medium">
                                  PO
                                </span>
                              )}
                            </div>
              ...
              <div>
                {selectedProducts.length > 0 ? (
                  <div className="bg-gradient-to-br from-green-50 to-emerald-50 border-2 border-green-300 rounded-[0.6vw] p-[1.25vw] h-full">
                    <h3 className="text-[0.95vw] font-semibold text-green-900 mb-[1vw]">
                      Record Payment - {selectedProducts.length} Product(s)
                    </h3>
                      ...
                      <div className="space-y-[1vw]">
                        <div className="grid grid-cols-2 gap-[1vw]">
                          <div>
                            ...
                            <select
                              ...
                              className="w-full px-[0.75vw] py-[0.6vw] border border-gray-300 bg-white rounded-[0.4vw] text-[0.8vw] outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            >
                        ...
                        <div>
                          ...
                          <textarea
                            ...
                            rows="2"
                            className="w-full px-[0.75vw] py-[0.6vw] border border-gray-300 bg-white rounded-[0.4vw] text-[0.8vw] outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500 resize-none"
                          />
                        </div>
                      </div>
                    )}
                    ...
                    {bulkPayment.paymentType === "po" && (
                      <div>
                        ...
                        <textarea
                          ...
                          rows="3"
                          className="w-full px-[0.75vw] py-[0.6vw] border border-gray-300 bg-white rounded-[0.4vw] text-[0.8vw] outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none"
                        />
                      </div>
                    )}

                    {/* UPDATED: Selected Products Summary with Total Estimate */}
                    <div className="bg-white rounded-[0.4vw] p-[0.75vw] mt-[1vw] border border-gray-200">
                      <p className="text-[0.75vw] font-semibold text-gray-700 mb-[0.5vw]">
                        Selected Products:
                      </p>
                      <div className="max-h-[8vw] overflow-y-auto space-y-[0.3vw]">
                        {selectedProducts.map((productId) => {
                          ...
                          return (
                            <div
                              key={productId}
                              className="flex items-center justify-between text-[0.7vw] py-[0.25vw] border-b border-gray-100 last:border-b-0"
                            >
                      ...
                      <div className="mt-[0.5vw] pt-[0.5vw] border-t-2 border-gray-300">
                        <div className="flex items-center justify-between mb-[0.25vw]">
                          <span className="text-[0.8vw] font-semibold text-gray-700">
                            Total Estimate:
                          </span>
                          <span className="text-[0.9vw] font-bold text-purple-700">
                            ₹{calculateSelectedTotal().toFixed(2)}
                          </span>
                        </div>
                        {bulkPayment.paymentType === "advance" && bulkPayment.amount && (
                          <div className="flex items-center justify-between">
                            <span className="text-[0.75vw] text-gray-600">
                              Receiving Now:
                            </span>
                            <span className="text-[0.85vw] font-bold text-green-600">
                    ...
                    {/* Action Buttons */}
                    <div className="flex gap-[0.75vw] mt-[1vw]">
                      <button
                        onClick={() => {
                          setSelectedProducts([]);
                          setBulkPayment({
                        ...
                        className="flex-1 px-[1vw] py-[0.6vw] border-2 border-gray-300 text-gray-700 bg-white rounded-[0.4vw] text-[0.8vw] font-medium cursor-pointer transition-all duration-200 hover:bg-gray-50"
                      >
                        Cancel
                      </button>
                      <button
                        onClick={addPaymentRecord}
                        className="flex-1 px-[1vw] py-[0.6vw] bg-green-600 text-white border-none rounded-[0.4vw] text-[0.8vw] font-semibold cursor-pointer transition-all duration-200 hover:bg-green-700 shadow-md"
                      >
                        Record Payment
                      </button>
                    </div>
                  ...
                  <div className="bg-gray-50 border-2 border-dashed border-gray-300 rounded-[0.6vw] p-[2vw] h-full flex flex-col items-center justify-center text-center">
                    <svg
                      className="w-[3vw] h-[3vw] text-gray-400 mb-[1vw]"
                      fill="none"
                      stroke="currentColor"
                      viewBox="0 0 24 24"
                    >
                    ...
                    <p className="text-[0.85vw] font-medium text-gray-600 mb-[0.25vw]">
                      No Products Selected
                    </p>
                    <p className="text-[0.75vw] text-gray-500">
                      Select products from the left to record payment
                    </p>
                  </div>
                )}
              </div>
            ...
            {paymentRecords.length > 0 && (
              <div className="mt-[1.25vw]">
                <h3 className="text-[0.85vw] font-semibold text-gray-800 mb-[0.75vw]">
                ...
                <div className="border-2 border-gray-200 rounded-[0.5vw] overflow-hidden max-h-[15vw] overflow-y-auto">
                  <table className="w-full">
                    <thead className="bg-gray-100 sticky top-0">
                      <tr>
                        <th className="text-left px-[1vw] py-[0.6vw] text-[0.75vw] font-semibold text-gray-700 border-b-2 border-gray-300">
                          Date & Time
                        </th>
                        <th className="text-left px-[1vw] py-[0.6vw] text-[0.75vw] font-semibold text-gray-700 border-b-2 border-gray-300">
                          Type
                        ...
                        <th className="text-right px-[1vw] py-[0.6vw] text-[0.75vw] font-semibold text-gray-700 border-b-2 border-gray-300">
                          Amount
                        </th>
                        <th className="text-center px-[1vw] py-[0.6vw] text-[0.75vw] font-semibold text-gray-700 border-b-2 border-gray-300">
                          Products
                        </th>
                        <th className="text-center px-[1vw] py-[0.6vw] text-[0.75vw] font-semibold text-gray-700 border-b-2 border-gray-300">
                          Action
                    ...
                    <tbody>
                      {paymentRecords.map((record) => (
                        ...
                        >
                          <td className="px-[1vw] py-[0.7vw] text-[0.7vw] text-gray-600">
                          ...
                          <td className="px-[1vw] py-[0.7vw]">
                            <span
                              className={`inline-block px-[0.6vw] py-[0.25vw] rounded-[0.3vw] text-[0.7vw] font-semibold ${
                          ...
                          <td className="px-[1vw] py-[0.7vw] text-[0.75vw] text-gray-700">
                            {record.paymentType === "advance" ? (
                              <div>
                                ...
                                {record.remarks && (
                                  <p className="text-[0.7vw] text-gray-500 mt-[0.15vw] truncate max-w-[12vw]">
                                    {record.remarks}
                                  </p>
                                )}
                              </div>
                            ) : (
                              <span className="text-[0.7vw] text-gray-500 truncate max-w-[12vw] block">
                          ...
                          <td className="px-[1vw] py-[0.7vw] text-center">
                            <span className="inline-block bg-gray-100 px-[0.6vw] py-[0.25vw] rounded-[0.3vw] text-[0.7vw] text-gray-700 font-medium">
                              {record.productIds.length}{" "}
                              {record.productIds.length === 1
                                ? "Product"
                                : "Products"}
                            </span>
                          </td>
                          <td className="px-[1vw] py-[0.7vw] text-center">
                            <button
                              ...
                              className="px-[0.75vw] py-[0.35vw] bg-red-500 text-white rounded-[0.3vw] text-[0.7vw] font-medium cursor-pointer hover:bg-red-600 transition-all"
                            >
                              Remove
                            </button>
                          </td>
...
// Keep all your existing helper components below (RgbaColorPickerInput, FileUploadBox, Section, Input, Select)
// [Include the rest of your component code - I've shown the key changes above]


// Keep all your existing component functions (RgbaColorPickerInput, FileUploadBox, Section, Input, Select) unchanged
// [Include the rest of your component code here - I've omitted it for brevity but it remains the same]
    ...
    <div className="relative">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-[0.75vw] py-[0.45vw] pr-[3.5vw] border border-gray-300 bg-white rounded-[0.5vw] text-[0.85vw] outline-none box-border focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all uppercase font-mono"
