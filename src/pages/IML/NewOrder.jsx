...
export default function NewOrder({
  ...
  const handleSaveProduct = (productId) => {
    ...
    if (!product.productName || !product.size || !product.imlType) {
    ...
    const confirmed = window.confirm(
      "Once saved, this product cannot be edited. However, you can still delete it if needed.\n\nDo you want to proceed?"
    );

    if (confirmed) {
      // Mark product as saved
      setProducts(
        products.map((p) => (p.id === productId ? { ...p, isSaved: true } : p))
      );
                  ...
                  <>
                    ...
                    <div className="bg-white rounded-[0.6vw] border-2 border-blue-200 p-[1vw] mb-[1vw]">
                      ...
                      <div className="grid grid-cols-4 gap-[1.5vw]">
                        ...
                        <Select
                          ...
                          disabled={!product.productName || product.isSaved}
                        />
                      ...
                      {product.designType === "existing" ? (
                        ...
                        <div>
                          <div className="mb-[1.25vw]">
                            <label className="flex items-center gap-[0.6vw] text-[0.85vw] text-gray-700 cursor-pointer w-fit">
                              <input
                                type="checkbox"
                    ...
                    <div className="flex justify-end mt-[0.5vw]">
                      <button
                        ...
                        disabled={product.isSaved}
                        className={`px-[2vw] py-[0.4vw] mt-[0.5vw] rounded-[0.5vw] text-[0.85vw] cursor-pointer transition-all duration-200 ${
                          product.isSaved
                            ? "bg-gray-400 cursor-not-allowed"
                            : "bg-[#374151] hover:bg-[#273040] text-white"
                        }`}
                      >
