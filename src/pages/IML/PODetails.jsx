...
const PODetails = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (globalLabelRef.current && !globalLabelRef.current.contains(event.target)) {
        setShowGlobalLabelSuggestions(false);
      }
      if (globalSupplierRef.current && !globalSupplierRef.current.contains(event.target)) {
  ...
  const handleApplyToAll = () => {
    ...
    Object.keys(updatedDetails).forEach(productId => {
      ...
      if (globalLabelType) updatedDetails[productId].labelType = globalLabelType;
  ...
  const handleProductAutocomplete = (productId, field, value) => {
    ...
    if (filtered.length > 0) {
      setActiveAutocomplete({ productId, field, options: filtered });
    } else {
      setActiveAutocomplete(null);
    }
  };

  // Select autocomplete option for product
  const selectProductAutocomplete = (productId, field, value) => {
    updateProductField(productId, field, value);
    setActiveAutocomplete(null);
  };
      ...
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center bg-white rounded-xl shadow-lg p-8 max-w-md">
          ...
          <p className="text-gray-600 mb-4">
            {orderId ? `Order ID "${orderId}" not found` : "No order ID provided"}
          </p>
          <button
        ...
        <div className="px-[1.5vw] py-[1vw] max-h-[75vh] overflow-auto">
          ...
          <div className="bg-white rounded-[0.6vw] border-2 border-blue-200 p-[1vw] mb-[1vw]">
            ...
            <div className="grid grid-cols-4 gap-[1.5vw]">
              <div>
                <label className="block text-[.85vw] font-medium text-gray-700 mb-[0.5vw]">Order Number</label>
                <div className="w-full text-[.85vw] px-[0.75vw] py-[0.45vw] border border-gray-300 bg-gray-50 rounded-[0.5vw]">
                  {order.orderNumber || "N/A"}
                </div>
              </div>
              <div>
                <label className="block text-[.85vw] font-medium text-gray-700 mb-[0.5vw]">Company Name</label>
                <div className="w-full text-[.85vw] px-[0.75vw] py-[0.45vw] border border-gray-300 bg-gray-50 rounded-[0.5vw]">
                  {order.contact?.company || "N/A"}
                </div>
              </div>
              <div>
                <label className="block text-[.85vw] font-medium text-gray-700 mb-[0.5vw]">Contact Name</label>
                <div className="w-full text-[.85vw] px-[0.75vw] py-[0.45vw] border border-gray-300 bg-gray-50 rounded-[0.5vw]">
                  {order.contact?.contactName || "N/A"}
                </div>
              </div>
              <div>
                <label className="block text-[.85vw] font-medium text-gray-700 mb-[0.5vw]">Contact Number</label>
                <div className="w-full text-[.85vw] px-[0.75vw] py-[0.45vw] border border-gray-300 bg-gray-50 rounded-[0.5vw]">
              ...
              <table className="w-full border-collapse">
                <thead>
                  <tr className="bg-gray-200">
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">S.No</th>
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">Product</th>
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">Size</th>
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">IML Name</th>
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">Type</th>
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">Lid Order Qty</th>
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-left text-[.85vw] font-semibold">Tub Order Qty</th>
                    ...
                    <th className="border border-gray-300 px-[1vw] py-[.75vw] text-center text-[.85vw] font-semibold">Action</th>
                  </tr>
                </thead>
                <tbody>
                  {purchaseProducts.map((product, idx) => {
                    ...
                    return (
                      <tr key={product.id || idx} className="hover:bg-gray-50">
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw]">{idx + 1}</td>
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw] font-medium">{product.productName}</td>
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw]">{product.size}</td>
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw]">{product.imlName}</td>
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw]">
                          <span className="inline-block px-2 py-1 bg-blue-100 text-blue-700 rounded text-xs font-semibold">
                            {product.imlType}
                          </span>
                        </td>
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw] font-semibold">{quantityLid}</td>
                        <td className="border border-gray-300 px-[1vw] py-[.75vw] text-[.85vw] font-semibold">{quantityTub}</td>

                        {/* PO Number Input */}
                        <td className="border border-gray-300 px-[.5vw] py-[.5vw]">
                          <input
                            type="text"
                            placeholder="PO #"
                            value={details.poNumber || ""}
                            onChange={(e) => updateProductField(product.id, 'poNumber', e.target.value)}
                            className="w-full text-[.8vw] px-[0.5vw] py-[0.35vw] border border-gray-300 rounded outline-none focus:ring-2 focus:ring-purple-500"
                          />
                        </td>

                        {/* Label Type Input with Autocomplete */}
                        <td className="border border-gray-300 px-[.5vw] py-[.5vw] relative">
                          <input
                            type="text"
                            ...
                            onFocus={() => {
                              if (details.labelType) {
                                handleProductAutocomplete(product.id, 'labelType', details.labelType);
                              }
                            }}
                            className="w-full text-[.8vw] px-[0.5vw] py-[0.35vw] border border-gray-300 rounded outline-none focus:ring-2 focus:ring-purple-500"
                          />
                          {activeAutocomplete?.productId === product.id && activeAutocomplete?.field === 'labelType' && (
                            <div className="absolute z-50 w-full bg-white border border-gray-300 rounded mt-1 shadow-lg max-h-[10vw] overflow-y-auto">
                              {activeAutocomplete.options.map((opt, i) => (
                                <div
                                  key={i}
                                  onClick={() => selectProductAutocomplete(product.id, 'labelType', opt)}
                                  className="px-2 py-1.5 hover:bg-purple-50 cursor-pointer text-[.8vw]"
                                >
                                  {opt}
                                </div>
                              ))}
                        ...
                        <td className="border border-gray-300 px-[.5vw] py-[.5vw] relative">
                          <input
                            ...
                            onFocus={() => {
                              if (details.supplier) {
                                handleProductAutocomplete(product.id, 'supplier', details.supplier);
                              }
                            }}
                            className="w-full text-[.8vw] px-[0.5vw] py-[0.35vw] border border-gray-300 rounded outline-none focus:ring-2 focus:ring-purple-500"
                          />
                          {activeAutocomplete?.productId === product.id && activeAutocomplete?.field === 'supplier' && (
                            <div className="absolute z-50 w-full bg-white border border-gray-300 rounded mt-1 shadow-lg max-h-[10vw] overflow-y-auto">
                              {activeAutocomplete.options.map((opt, i) => (
                                <div
                                  key={i}
                                  onClick={() => selectProductAutocomplete(product.id, 'supplier', opt)}
                                  className="px-2 py-1.5 hover:bg-purple-50 cursor-pointer text-[.8vw]"
                                >
                                  {opt}
                                </div>
                  ...
                  <div className="absolute z-50 w-full bg-white border border-gray-300 rounded-[0.5vw] mt-[0.25vw] shadow-lg max-h-[12vw] overflow-y-auto">
                    {filteredGlobalSuppliers.map((supplier, idx) => (
                      <div
                        ...
                        className="px-[1vw] py-[0.6vw] hover:bg-amber-50 cursor-pointer border-b border-gray-100 last:border-b-0"
                      >
                        <p className="text-[.85vw] font-medium text-gray-800">{supplier}</p>
                      </div>
                    ))}
                  </div>
                )}
              ...
              <div className="p-[1.5vw]">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 rounded-[0.6vw] border-2 border-blue-200 p-[1vw] mb-[1vw]">
                  <h3 className="text-[1vw] font-semibold text-blue-900 mb-[1vw] flex items-center gap-2">
                    <span className="text-[1.2vw]">📦</span> Product Information
                  </h3>
                  <div className="grid grid-cols-2 gap-[1vw]">
                    <div>
                      <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Product Category</label>
                    ...
                    <div>
                      <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">IML Type</label>
                ...
                <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-[0.6vw] border-2 border-green-200 p-[1vw] mb-[1vw]">
                  <h3 className="text-[1vw] font-semibold text-green-900 mb-[1vw] flex items-center gap-2">
                    <span className="text-[1.2vw]">📊</span> Quantity Information
                  </h3>
                    ...
                    <div className="space-y-[1vw]">
                      ...
                      <div>
                        <h4 className="text-[.9vw] font-semibold text-green-800 mb-[0.5vw] flex items-center gap-2">
                          <span className="bg-green-600 text-white px-2 py-0.5 rounded text-[.75vw]">LID</span>
                        </h4>
                        <div className="grid grid-cols-3 gap-[1vw]">
                          <div>
                            <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Label Order Qty</label>
                          ...
                          <div>
                            <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Production Qty</label>
                          ...
                          <div>
                            <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Remaining Stock</label>
                      ...
                      <div>
                        <h4 className="text-[.9vw] font-semibold text-green-800 mb-[0.5vw] flex items-center gap-2">
                          <span className="bg-blue-600 text-white px-2 py-0.5 rounded text-[.75vw]">TUB</span>
                        </h4>
                        <div className="grid grid-cols-3 gap-[1vw]">
                          <div>
                            <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Label Order Qty</label>
                    ...
                    <div className="grid grid-cols-3 gap-[1vw]">
                      <div>
                        <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">
                          {hasLidQty ? "LID Label Order Qty" : "TUB Label Order Qty"}
                        </label>
                        <div className="text-[.85vw] px-[0.75vw] py-[0.4vw] bg-white border border-gray-300 rounded-[0.4vw] font-bold text-green-700">
                          {hasLidQty ? (viewingProduct.lidLabelQty || "0") : (viewingProduct.tubLabelQty || "0")}
                        </div>
                      </div>
                      <div>
                        <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">
                          {hasLidQty ? "LID Production Qty" : "TUB Production Qty"}
                        </label>
                        <div className="text-[.85vw] px-[0.75vw] py-[0.4vw] bg-white border border-gray-300 rounded-[0.4vw] font-bold text-blue-700">
                          {hasLidQty ? (viewingProduct.lidProductionQty || "0") : (viewingProduct.tubProductionQty || "0")}
                        </div>
                      </div>
                      <div>
                        <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">
                          {hasLidQty ? "LID Remaining Stock" : "TUB Remaining Stock"}
                        </label>
                        <div className="text-[.85vw] px-[0.75vw] py-[0.4vw] bg-white border border-gray-300 rounded-[0.4vw] font-bold text-orange-700">
                          {hasLidQty ? (viewingProduct.lidStock || "0") : (viewingProduct.tubStock || "0")}
                        </div>
                      </div>
                    </div>
                  )}
                ...
                <div className="bg-gradient-to-br from-amber-50 to-yellow-50 rounded-[0.6vw] border-2 border-amber-200 p-[1vw]">
                  <h3 className="text-[1vw] font-semibold text-amber-900 mb-[1vw] flex items-center gap-2">
                    <span className="text-[1.2vw]">📋</span> Purchase Order Details
                  </h3>
                  <div className="grid grid-cols-3 gap-[1vw]">
                    <div>
                      <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">PO Number</label>
                      <div className="text-[.85vw] px-[0.75vw] py-[0.4vw] bg-white border border-gray-300 rounded-[0.4vw] font-semibold">
                        {productPODetails[viewingProduct.id]?.poNumber || "Not Set"}
                      </div>
                    </div>
                    <div>
                      <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Label Type</label>
                      <div className="text-[.85vw] px-[0.75vw] py-[0.4vw] bg-white border border-gray-300 rounded-[0.4vw] font-semibold">
                        {productPODetails[viewingProduct.id]?.labelType || "Not Set"}
                      </div>
                    </div>
                    <div>
                      <label className="block text-[.8vw] font-medium text-gray-700 mb-[0.3vw]">Supplier Name</label>
                      <div className="text-[.85vw] px-[0.75vw] py-[0.4vw] bg-white border border-gray-300 rounded-[0.4vw] font-semibold">
                        {productPODetails[viewingProduct.id]?.supplier || "Not Set"}
                      </div>
                    </div>
                  </div>
                </div>
