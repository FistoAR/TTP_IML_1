...
export default function ScreenPrintingOrders() {
  ...
  const handleMoveToPurchase = (order) => {
    ...
    const alreadyMoved = order.products.some((p) => p.moveToScreenPrinting === true);
  ...
  const stats = {
    ...
    movedToPurchase: orders.reduce((count, order) => {
      ...
      const moved = order.products.some((p) => p.moveToScreenPrinting === true);
      ...
      <div className="mb-[1.25vw]">
        <div className="flex justify-between items-center mb-[.25vw]">
          <h1 className="text-[1.6vw] font-bold text-gray-900">
            Orders Management (Screen Printing)
          </h1>
                                                ...
                                                <td className="px-[0.8vw] py-[0.65vw]">
                                                  <div className="flex items-center justify-center gap-2">
                                                    ...
                                                    <button
                                                      ...
                                                      className={`font-medium ${order.products?.some((p) => p.moveToScreenPrinting === true)
                                                          ? "text-green-600 cursor-not-allowed"
                                                          : "text-purple-600 hover:text-purple-800 cursor-pointer"
                                                        } `}
                                                      disabled={order.products?.some((p) => p.moveToScreenPrinting === true)}
                                                    >
